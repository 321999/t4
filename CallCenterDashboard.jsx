...
const CallCenterDashboard = () => {
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-blue-100">
                {uploadedData ? `Real data: ${kpis.totalCalls} calls` : `Demo data: ${kpis.totalCalls} calls`}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <MetricCard
                  ...
                  value={kpis.answeredCalls.toLocaleString()}
                  subtitle={`${kpis.notAnswered} not answered`}
                  icon={Phone}
                  color="#00C49F"
                />
                <MetricCard
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white p-5 rounded-lg shadow-md border-l-4 border-yellow-500">
                  ...
                  <p className="text-3xl font-bold text-yellow-600 mt-2">{kpis.avgAHT} min</p>
                ...
                <div className="bg-white p-5 rounded-lg shadow-md border-l-4 border-blue-500">
                  ...
                  <p className="text-3xl font-bold text-blue-600 mt-2">{kpis.avgTalkTime} min</p>
                ...
                <div className="bg-white p-5 rounded-lg shadow-md border-l-4 border-purple-500">
                  ...
                  <p className="text-3xl font-bold text-purple-600 mt-2">{kpis.avgHoldTime} min</p>
                ...
                <div className="bg-white p-5 rounded-lg shadow-md border-l-4 border-pink-500">
                  ...
                  <p className="text-3xl font-bold text-pink-600 mt-2">{kpis.avgWrapupTime} min</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="overflow-y-auto max-h-80">
                  <table className="w-full">
                    ...
                    <tbody>
                      {dispositionData.map((disp, idx) => (
                        <tr key={idx} className={idx % 2 === 0 ? 'bg-gray-50' : ''}>
                          <td className="px-4 py-2">{disp.name}</td>
                          <td className="px-4 py-2 text-right font-semibold">{disp.value}</td>
                          <td className="px-4 py-2 text-right">{disp.percentage}%</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
  ...
  <div className="bg-white rounded-xl shadow-md p-6">
    <h3 className="text-lg font-semibold mb-4">Raw Uploaded Data</h3>

    {!uploadedData ? (
      <p className="text-gray-500">Please upload a CSV file to view raw data.</p>
    ) : (
